...
Smartphone Compatible web template, free web designs for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link rel="stylesheet" href="{{asset('dist/css/flexslider.css')}}" type="text/css" media="screen" Department="" />
    <link href="{{asset('dist/css/services.css')}}" rel="stylesheet" type="text/css" media="all" />
    <link href="{{asset('dist/css/ziehharmonika.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('dist/css/JiSlider.css')}}" rel="stylesheet">
                ...
                <div class="w3layouts-banner-top">
                    ...
                    <div class="container">
                        <div class="agileits-banner-info">
                            <span>Mobile Clinic</span>
                            <h3>Quality Care </h3>
                            <p>We offer medical care using mobile clinics and emergency response to any kind of tragedy that requires medical attention</p>
                ...
                <div class="w3layouts-banner-top w3layouts-banner-top1">
                    <div class="container">
                        <div class="agileits-banner-info">
                            ...
                            <p>We offer free consultation and emergency response to baringo county residents, both young and old.</p>
                ...
                <div class="w3layouts-banner-top w3layouts-banner-top2">
                    <div class="container">
                        <div class="agileits-banner-info">
                            <span>Amazing</span>
                            <h3>Quality Care </h3>
                            <p>Our service is quality at a cheap affordable price, with no discrimination</p>
...
<div class="about" id="about">
    <div class="container">
        <h2 class="w3_heade_tittle_agile">Welcome to Baringo county</h2>
        <p class="sub_t_agileits">Add Short Description</p>

        <p class="ab">The second administration of Baringo County will refocus the development agenda by embracing economic cluster approach to achieve comparative production advantage. As a county we are blessed, hence the reason we have invested in mobile clinics to allow those who do not have fast acces to hospital can have medical attention at their door steps.</p>

        <div class="about-w3lsrow">

            <div class="col-md-6 w3about-img">
                <img src="{{asset('dist/images/about.jpg')}}" alt=" " class="img-responsive">
            </div>
            <div class="col-md-6 col-sm-7 w3about-img two">
                <div class="w3about-text">
                    <h5 class="w3l-subtitle">We Care About Your Health</h5>
                    <p>Baringo county cares about your health. A healthy county is a productive county. In order to accord high
                        quality and reliable health and therefore improved productivity for its residents, Baringo County Government has since 2013 to date invested heavily on health sector.</p>
...
<div class="agile_menu" id="menu">
    <div class="container">
        ...
        <p class="sub_t_agileits">They work round the clock</p>
            ...
            <div class="ziehharmonika">
                ...
                <div>
                    <div class="w3_agile_recipe-grid">
                        ...
                        <div class="col-md-6 col-sm-6 tab-image">
                            <img src="{{asset('dist/images/g5.jpg')}}" alt="Medicinal">
                        </div>
                        <div class="col-md-6 col-sm-6 tab-info">
                            <h4>No more house deliveries</h4>
                            <p>Sometimes labour can be unexpected. When those times come and you are not prepared, Baringo county mobile clinics got you covered. We offer emergency care to deivering mothers so as to ensure the saftery of both the mother and the child. </p>
                            <div class="read"><a href="" class="hvr-rectangle-in">Read More</a></div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                ...
                <div>
                    <div class="w3_agile_recipe-grid">
                        ...
                        <div class="col-md-6 col-sm-6 tab-info two">
                            ...
                            <p>We do quick dental checkups... </p>
                            <div class="read"><a href="#" class="hvr-rectangle-in">Read More</a></div>
                        </div>
                        <div class="col-md-6 col-sm-6 tab-image two">
                            <img src="{{asset('dist/images/g6.jpg')}}" alt="Medicinal">
                        </div>
                        <div class="clearfix"></div>
                    </div>
                ...
                <div>
                    <div class="w3_agile_recipe-grid">
                        ...
                        <div class="col-md-6 col-sm-6 tab-image">
                            <img src="{{asset('dist/images/g7.jpg')}}" alt="Medicinal">
                        </div>
                        <div class="col-md-6 col-sm-6 tab-info">
                            <h4>We are having department to us</h4>
                            <p>Also our eye checkup equipment comes in handy to help our citizens... </p>
                            <div class="read"><a href="#" class="hvr-rectangle-in">Read More</a></div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                ...
                <div>
                    <div class="w3_agile_recipe-grid">
                        ...
                        <div class="col-md-6 col-sm-6 tab-info two">
                            <h4>We are having department to us</h4>
                            <p>We care for ophaned children medical requirements and also medicine... </p>
                            <div class="read"><a href="#" class="hvr-rectangle-in">Read More</a></div>
                        </div>
                        <div class="col-md-6 col-sm-6 tab-image two">
                            <img src="{{asset('dist/images/g2.jpg')}}" alt="Medicinal">
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>
...
<div class="service-w3l jarallax" id="service">
    <div class="container">
        ...
        <p class="sub_t_agileits">Baringo county cares</p>
        <div class="col-lg-4 col-md-4 col-sm-12 serv-agileinfo1">
            <div class="col-lg-12 col-md-12 col-sm-6 serv-wthree1" data-aos="zoom-in">
                ...
                <p class="text-center">We are just a call away to your location</p>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-6 serv-wthree2" data-aos="zoom-in">
                ...
                <p class="text-center">Our doctors endevor to give patients the best expirience.</p>
            </div>
            <div class="clearfix"></div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 serv-agileinfo2">
            <div class="col-lg-12 col-md-12 col-sm-6 serv-wthree4" data-aos="zoom-in">
                ...
                <p class="text-center">Fast emergency response.</p>
            </div>
            <div class="clearfix"></div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 serv-agileinfo3">
            <div class="col-lg-12 col-md-12 col-sm-6 serv-wthree6" data-aos="zoom-in">
                ...
                <p class="text-center">Free delivery in emergency cases</p>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-6 serv-wthree5" data-aos="zoom-in">
                ...
                <p class="text-center">We offer medical tests and treatment to all Baringo citizens.</p>
            </div>
            <div class="clearfix"></div>
        </div>
        <div class="clearfix"></div>
                ...
                <ul class="slides">
                    ...
                    <li>
                        <div class="w3_agile_services_bottom_right_grid1">
                            <p class="w3layouts_head_slide">Mobile <span> Clinics</span></p>
                        </div>
                    </li>
                    <li>
                        <div class="w3_agile_services_bottom_right_grid2">
                            <p class="w3layouts_head_slide">Fast <span>Response</span></p>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <div class="col-md-7 wthree_services_bottom_left">
        <div class="wthree_services_bottom_left_grid">
            <div class="col-md-6 w3_agileits_services_bottom_l_grid">
                <div class="agile_services_bottom_l_grid1">
                    <img src="{{asset('dist/images/g4.jpg')}}" alt=" " class="img-responsive" />
            ...
            <div class="col-md-6 w3_agileits_services_bottom_r_grid">
                <h4>Best Medical Staff</h4>
                <p>We have the best caring medical staff the works round the clock to ensure that all Baringo residents access fast medical attention.</p>
        ...
        <div class="wthree_services_bottom_left_grid">
            <div class="col-md-6 w3_agileits_services_bottom_r_grid">
                ...
                <p>Our clinics com with the best medical equipment to do all kind of checks.</p>

            </div>
            <div class="col-md-6 w3_agileits_services_bottom_l_grid">
                <div class="agile_services_bottom_l_grid1">
                    <img src="{{asset('dist/images/g2.jpg')}}" alt=" " class="img-responsive" />
                    <div class="w3_service_bottom_grid_pos">
                        <h3>Quality Care</h3>
                    </div>
                </div>
            ...
            <div class="w3agile_footer_grids">
                ...
                <div class="col-md-4 w3agile_footer_grid">
                    ...
                    <ul>
                        ...
                        <li><i class="fa fa-phone" aria-hidden="true"></i>+254 723 456 345</li>
                    </ul>
                </div>
...
<script src="{{asset('dist/js/JiSlider.js')}}"></script>
<script>
    $(window).load(function () {
        $('#JiSlider').JiSlider({color: '#ff001a', start: 3, reverse: true}).addClass('ff')
    })
...
<script src="{{asset('dist/js/ziehharmonika.js')}}"></script>
<script>
...
<script src="{{asset('dist/js/jquery.countup.js')}}"></script>
<script>
    $('.counter').countUp();
</script>
<!-- //stats -->
